              ...
              <div class="col-sm-12">
                ...
                <div class="row padd-infor">
                  ...
                  <div class="col-sm-4 infor">
                    ...
                    ';
                    if($infor_order->Status != "Đã hủy" && $infor_order->Status != "Đã giao hàng"){
                      echo'<select class="news news2 input-news" name="Status">
                      <option>'.$infor_order->Status.'</option>
                      <option value="Đang giao hàng">Đang giao hàng</option>
                      
                      <option value="Đã giao hàng">Đã giao hàng</option>
                    </select>';
                    }else{
                      echo'<div class="news news2 input-news">'.$infor_order->Status.'</div>';
                    }
                    echo'
                  </div>
                </div>';
                if ($infor_order->Status == "Đã hủy") {
                  echo'<div class="row padd-infor">
                  <div class="col-sm-12 infor">
                    <div class="infor">Lý do hủy đơn hàng:</div>
                    <div class="news news2 input-news">'.$infor_order->Price.'</div>
                  </div>
  ...
  echo'<nav class="navbar navbar-light">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
              ...
              swal({
                ...
                swal({
                  title: "Thất bại",
                  text: "Bạn cập nhật thông tin đơn hàng không thành công",
                  icon: "error",
                  button: "Aww yiss!",
                });
                </script>';
            ...
            echo'<div class="col-sm " style="margin-top: 15px;text-align:center"><input class="btn btn-sm btn-outline-secondary btnn" style="margin:0px" type="submit" value="Lưu">
        ';
          
        
        
        echo'
        <a href="index.php?controller=pages&action=inforOrder"><input class="btn btn btn-sm btn-outline-secondary  " style="width:100px" value="Quay lại"></a>
</form>    </div>
            </div>
          

';if ($infor_order->Status != "Đã hủy" && $infor_order->Status != "Đã giao hàng") {
  echo'<div style="text-align:center; margin-top:10px"><a onclick="showForm()" class="btn btn-secondary btn-sm" style="background-color: white;color:black">Hủy đơn hàng</a></div>
  <form action="index.php?controller=users&action=cancellistrproordercus&orderId='.$infor_order->orderId.'&Email='.$infor_order->Email.'" method="post">
  <div class="form-cancel" style="display:none;text-align:center">
