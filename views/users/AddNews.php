                  ...
                  <div class="col-sm-9">
                    <div class="row padd-news">
                      <div class="col-sm news">
                        ...
                        <input class="news news2 input-news" type="text" placeholder="Nhập tiêu đề bài viết" name="Title">
                      </div>
                      <div class="col-sm news">
                        <div class="news">Ngày đăng</div>
                        <input class="news news2 input-news" type="text" placeholder="Nhập tiêu đề bài viết" name="DateSubmitted">
                      </div>
                    </div>
                    <div class="row padd-news">
                      <div class="col-sm news">
                        <div class="news">Danh mục</div>
                        <input class="news news2 input-news" type="text" placeholder="Nhập danh mục (thể loại)"
                          name="Category">
                      </div>
                      <div class="col-sm news">
                  ...
                  <div class="col-sm-9">
                    <div class="row">
                      <div class="col-sm news">
                        ...
                        <input class="news news2 input-news" type="text" placeholder="Nhập danh mục (thể loại)" name="Content">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                if ($result == "Insert OK") {
                  ...
                  <div class="col-sm " style="margin-top: 15px;">
                    <input type="submit" class="btn btn btn-sm btn-outline-secondary btnn  " value="Lưu bài viết">
                  </div>
                </div>
              </form>
            </div>
