        ...
        <div class="title1">
            <nav class="navbar navbar-light background-white">
                <div class="container-fluid">
                    <a class="navbar-brand">Quản lý giảm giá</a>
                </div>
            </nav>
        </div>
        ...
        <div class="content">
            <nav class="navbar navbar-light background-white">
                <div class="container-fluid title">
                    <a class="navbar-brand">Thông tin mã giảm giá</a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row padd-infor">
                    <div class="col-sm web">
                        <div class="web">Mã giảm giá</div>
                        <input class="news news2 input-news" type="text"
                            placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->DiscountCode.'" name="DiscountCode">
                    </div>
                    <div class="col-sm web">
                        <div class="web">Tên giảm giá</div>
                        <input class="news news2 input-news" type="text"
                            placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->DiscountName.'" name="DiscountName">
                    </div>
                </div>
                <div class="row padd-infor">
                    <div class="col-sm web">
                        <div class="web">Từ ngày(Năm-Tháng-Ngày):</div>
                        <input class="news news2 input-news" type="text"
                            placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->Since.'" name="Since">
                    </div>
                    <div class="col-sm web">
                        <div class="web">Đến ngày(Năm-Tháng-Ngày):</div>
                        <input class="news news2 input-news" type="text"
                            placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->ToDate.'" name="ToDate">
                    </div>
                </div>
                <div class="row padd-infor">
                  <div class="col-sm web">
                      <div class="web">Giá trị</div>
                      <input class="news news2 input-news" type="text"
                            placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->Value.'" name="Value">
                  </div>
                  <div class="col-sm web">
                  <div class="web">Trạng thái</div>
                    <select class="news news2 input-news" name="Status">
                    ';
                    if ($infor_sale->Status == "Đang kích hoạt") {
                      echo'<option value="Đang kích hoạt">Đang kích hoạt</option>';
                    }
                    if ($infor_sale->Status == "Không kích hoạt") {
                      echo'<option value="Không kích hoạt">Không kích hoạt</option>';
                    }
                    ;echo'
...
<div class="row row3 " style="text-align: center;">
    <div class="col-sm " style="margin-top: 15px;">
        ...
        <a href="index.php?controller=pages&action=inforSale"><input class="btn btn btn-sm btn-outline-secondary  " style="width:50px" value="Hủy"></a>
    </div>
</div>
</div>
...
<!-- <div class="col-6 infor padd-infor">
    <div class="infor">Địa chỉ</div>
    <div class="infor infor2">353 tam trinh, hoàng mai, hai bà trưng, hà nội. 353 tam trinh, hoàng mai, hai bà trưng, hà nội. 353 tam trinh, hoàng mai, hai bà trưng, hà nội</div>
</div> -->