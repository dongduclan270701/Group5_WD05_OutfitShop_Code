...
<?php
echo'                          <input class="news news2 input-news" type="text" placeholder="Nhập mới" value="'.$profilees->Email.'" name="Email"
disabled="true">';
?>
                        </div>
                        <!-- <div class="col-sm-12 web">
                          <div class="web">Password hiện tại:</div>
                          <input class="news news2 input-news" type="password" placeholder="Nhập mới" name="password">
                        </div> -->
                        <div class="col-sm-12 web">
                          <div class="web">Password mới:</div>
                          <input class="news news2 input-news" type="password" placeholder="Nhập mới" name="password">
                        </div>
