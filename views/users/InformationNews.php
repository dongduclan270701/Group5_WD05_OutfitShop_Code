                ...
                <div class="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row padd-news">
                                <div class="col-sm news">
                                    ...
                                    <div class="news news2 input-news">'.$infor_news->id.'</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_news->id.'" name="id" style="display:none;" >
                                </div>
                                <div class="col-sm news">
                                    <div class="news">Tiêu đề</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_news->Title.'" name="Title">
                                </div>
                            </div>
                            <div class="row padd-news">
                                <div class="col-sm news">
                                    ...
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập danh mục (thể loại)" value="'.$infor_news->Category.'" name="Category">
                                </div>
                                <div class="col-sm news">
                                    <div class="news">Người đăng</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập danh mục (thể loại)" value="'.$infor_news->PostedBy.'" name="PostedBy">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="image-news">
                                <div class="col-sm">
                                    ...
                                    <input type="file" name="Image" value="'.$infor_news->Image.'" accept="image/x-png,image/gif,image/jpeg" class="btn btn-sm btn-news">
                                </div>
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col news">
                                    ...
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập danh mục (thể loại)" value="'.$infor_news->Content.'" name="Content">
                                </div>
                            </div>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        <div class="col-sm " style="margin-top: 15px;">
                            ...
                            <a href="index.php?controller=pages&action=inforNews"><input class="btn btn btn-sm btn-outline-secondary  " style="width:50px" value="Hủy"></a>
                        </div>
                    </div>
    </form>
</div>
