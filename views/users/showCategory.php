        ...
        <div class="content">
          <nav class="navbar navbar-light background-white">
            <div class="container-fluid title">
              <a class="navbar-brand">Thông tin danh mục</a>
            </div>
              ...
              <div class="row navbar">
                ...
                <div class="col-4 web">
                    ...
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->id.'" name="id" disabled="false">
                  </div>
                  <div class="col-4 web">
                    <div class="web">Danh mục</div>
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->NameCategory.'" name="NameCategory" disabled="false">
                  </div>
                  <div class="col-4 web">
                    <div class="web">Thể loại</div>
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->Category.'" name="Category" disabled="false">
                  </div>
                  <div class="col-4 web">
                    <div class="form-check padd-infor">
                      <input class="form-check-input" type="checkbox" id="flexCheckIndeterminate"  disabled="false">
                  ...
                  <div class="col-12">
                    <div class="row row3 " style="text-align: center;">
                      <div class="col " style="margin-top: 15px;">
                        <?php echo'<a href="index.php?controller=users&action=updateCategory&id=' . $infor_category->id . '"><input class="btn btn btn-sm btn-outline-secondary btnn  " value="Chỉnh sửa danh mục"></a>'; ?>
                      </div>
                    </div>
                  </div>
