                            ...
                            <div class="row padd-infor">
                                <div class="col-sm web">
                                    ...
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->DiscountCode.'" name="DiscountCode"  disabled="false">
                                </div>
                                <div class="col-sm web">
                                    <div class="web">Tên giảm giá</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->DiscountName.'" name="DiscountName"  disabled="false">
                                </div>
                            </div>
                            <div class="row padd-infor">
                                <div class="col-sm web">
                                    <div class="web">Từ ngày</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->Since.'" name="Since"  disabled="false">
                                </div>
                                <div class="col-sm web">
                                    <div class="web">Đến ngày</div>
                                    <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->ToDate.'" name="ToDate"  disabled="false">
                                </div>
                            </div>
                            <div class="row padd-infor">
                              <div class="col-sm web">
                                  ...
                                  <input class="news news2 input-news" type="text"
                                        placeholder="Nhập tiêu đề bài viết" value="'.$infor_sale->Value.'" name="Value" disabled="false">
                              </div>
                              <div class="col-sm web">
                            ...
                            <div class="col-sm-9">       
                                <div class="row row3 " style="text-align: center;">
                                    <div class="col-sm " style="margin-top: 15px;">
                                        <?php echo'<a href="index.php?controller=users&action=updateSale&DiscountCode=' . $infor_sale->DiscountCode . '"><input class="btn btn btn-sm btn-outline-secondary btnn " value="Chỉnh sửa"></a>'; ?>
                                    </div>
                                </div>
                            </div>
