            ...
            <div class="container-fluid">
              <form action="" method="post">
                ...
                <div class="col-sm-8">
                  <div class="row padd-infor">
                    <div class="col-sm-12 infor" style="padding-bottom: 25px;">
                      ...
                      <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" name="ProductCode">
                    </div>
                    <div class="col-sm-12 infor ">
                      <div class="infor">Tên sản phẩm:</div>
                      <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" name="ProductName">
                    </div>
                  ...
                  <div class="row padd-infor">
                    <div class="col-sm-6 infor">
                      ...
                      <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" name="ProductPrice">
                    </div>
                    <div class="col-sm-6 infor ">
                      <div class="infor">Giảm giá:</div>
                      <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" name="Discount">
                    </div>
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-12">
                    <div class="infor">Vui lòng chọn ảnh 1:</div>
                      <input type="file" name="Image1"  accept="image/x-png,image/gif,image/jpeg" class="btn btn-sm btn-news">
                    </div>
                    <div class="col-sm-12">
                    <div class="infor">Vui lòng chọn ảnh 2:</div>
                      <input type="file" name="Image2"  accept="image/x-png,image/gif,image/jpeg" class="btn btn-sm btn-news">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-4 infor padd-infor">
                  ...
                  <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" name="Quanlity">
                </div>
              </div>';
