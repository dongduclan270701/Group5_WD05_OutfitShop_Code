          ...
          <div class="content">
            <nav class="navbar navbar-light background-white">
              <div class="container-fluid title">
                <a class="navbar-brand">Thay đổi thông tin danh mục</a>
              </div>
            ...
            <div class="container-fluid">
              <form action="" method="post">
                ...
                <div class="col-4 web">
                    <div class="web">ID</div>
                    <div class="news news2 input-news">'.$infor_category->id.'</div>
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->id.'" name="id" style="display:none;">
                  </div>
                  <div class="col-4 web">
                    <div class="web">Danh mục</div>
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->NameCategory.'" name="NameCategory">
                  </div>
                  <div class="col-4 web">
                    <div class="web">Thể loại</div>
                    <input class="news news2 input-news" type="text"
                                            placeholder="Nhập mới" value="'.$infor_category->Category.'" name="Category">
                  </div>
...
<div class="row row3 " style="text-align: center;">
  <div class="col " style="margin-top: 15px;">
    ...
    <a href="index.php?controller=pages&action=inforCategory"><input class="btn btn btn-sm btn-outline-secondary  " style="width:50px" value="Hủy"></a>
  </div>
</div>
</div>
