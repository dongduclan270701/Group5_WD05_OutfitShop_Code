    ...
    <div class="col-sm-10">
        ...
        <div class="content">
                      ...
                      <div class="row padd-infor">
                          <div class="col-sm-4 web">
                              ...
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->Hotline.'" name="Hotline">
                          </div>
                          <div class="col-sm-4 web">
                              <div class="web">Chăm sóc khách hàng:</div>
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->CustomerCare.'" name="CustomerCare">
                          </div>
                          <div class="col-sm-4 web">
                              <div class="web">Email shop:</div>
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->EmailShop.'" name="EmailShop">
                          </div>
                      </div>
                      <div class="row padd-infor">
                          <div class="col-sm web">
                              ...
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->LinkFacebook.'" name="LinkFacebook">
                          </div>
                          <div class="col-sm web">
                              <div class="web">Link Instagram:</div>
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->LinkInstagram.'" name="LinkInstagram">
                          </div>
                      </div>
                      <div class="row padd-infor">
                          <div class="col-sm web">
                              ...
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->LinkShopee.'" name="LinkShopee">
                          </div>
                          <div class="col-sm web">
                              <div class="web">Link Lazada:</div>
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->LinkLazada.'" name="LinkLazada">
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-sm-9">
                      <div class="row padd-infor">
                          <div class="col-sm web">
                              ...
                              <input class="news news2 input-news" type="text"
                                  placeholder="Nhập mới" value="'.$infor_websitee->ShopAddress.'" name="ShopAddress">
                          </div>
                      </div>
                      <div class="col-sm-3">
                      <img src="assets/images/Capture.PNG" alt="" style="width:100%">
                  </div>
              ';
          }
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            // echo '<span style="text-align: center;">'.$update.'</span>';
            if ($update == "Update OK") {
              echo '<script>
              swal({
                title: "Thành công",
          ...
          <div class="col-sm " style="margin-top: 15px;">
              <input type="submit" class="btn btn-sm btn-outline-secondary btnn " value="Lưu">
              <a href="index.php?controller=pages&action=inforWebsite"><input class="btn btn btn-sm btn-outline-secondary  " style="width:50px" value="Hủy"></a>
          </div>
      </div>
  </div>
