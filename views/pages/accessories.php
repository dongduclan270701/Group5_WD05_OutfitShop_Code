		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" data-type="all">Trang chủ / Phụ kiện</a></li>
		...
		<section class="cd-gallery">
			<ul>
				...
				foreach ($accessories as $accessoriess){
					echo'<li class="mix '.$accessoriess->ProductName.' Màu-'.$accessoriess->Color.' accessories"><img
					src="'.$accessoriess->Image1.'" alt="T-Shirt">
				<h5 class="jet-woo-product-title">
					<a href="index.php?controller=pages&action=PnotSC&ProductCode='.$accessoriess->ProductCode.'" rel="bookmark">
						'.$accessoriess->ProductName.'
					</a>
				</h5>
				<div class="jet-woo-product-price">
					<span class="woocommerce-Price-amount amount">
						<bdi> 
							'. number_format("$accessoriess->ProductPrice",0,",",","). ' 
			...
			<form action="" method="post">
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Phụ kiện 1">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".T-Shirt" type="radio" id="T-Shirt" name="radioButton">
							<label class="radio-label" for="T-Shirt">T-Shirt</label>
						</li>
						<li>
							<input class="filter" data-filter=".Áo-sơ-mi" type="radio" id="Áo-sơ-mi" name="radioButton">
							<label class="radio-label" for="Áo-sơ-mi">Áo-sơ-mi</label>
						</li>
						<li>
							<input class="filter" data-filter=".Quần-dài" type="radio" id="Quần-dài" name="radioButton">
							<label class="radio-label" for="Quần-dài">Quần-dài</label>
						</li>
						<li>
							<input class="filter" data-filter=".Quần-Shorts" type="radio" id="Quần-Shorts" name="radioButton">
							<label class="radio-label" for="Quần-Shorts">Quần-Shorts</label>
						</li>
						<li>
							<input class="filter" data-filter=".Áo-Khoác" type="radio" id="Áo-Khoác" name="radioButton">
							<label class="radio-label" for="Áo-Khoác">Áo-Khoác</label>
						</li>
						<li>
							<input class="filter" data-filter=".accessories" type="radio" id="accessories" checked>
							<label class="radio-label" for="accessories">Phụ kiện</label>
						</li>
