  ...
  <div class="col-sm-2 ">
          <div class="nav-head-content" style="    height: auto;">
              <ul id="accordion" class="accordion">
                ...
                <li>
                  <a href="index.php?controller=pages&action=inforProfile"><div class="link color-text"><i class="fa fa-user-circle"></i>Quản lý hồ sơ</div></a>
...
font-size: 13px;">
                          ...
                          <th class="display">Họ tên</th>
                          <th class="display">Hình ảnh</th>
                          <th class="display">Khóa quyền</th>
                          <th class="display">Ghi chú</th>
                          <th>Tác vụ</th>
                        </tr>
                      </thead>
                  
                  <tbody>';
                  foreach ($infor_profile as $infor_profilee){
                                echo '
                                <tr style="text-align: center;
                                font-size: 13px;">
                                <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_profilee->id.'</p></th>
                                <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">' .$infor_profilee->UserName .'</p></th>
                                <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">' .$infor_profilee->Name .' '. $infor_profilee->Surname.'</p></th>
                                <th class="display"><img src="'.$infor_profilee->Image.'" alt="" style="width:44px"></th>
                                
                                <th  class="display" style="vertical-align: inherit;"><p style=" font-weight: normal !important;margin: auto; padding: inherit;"><label class="form-check-label" for="flexCheckIndeterminate">
                                  Khóa tài khoản
                                </label></p></th>
                                <th  class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_profilee->Note.'</p></th>
                                <th style="vertical-align: inherit;"><a href="index.php?controller=users&action=updateProfile&id=' . $infor_profilee->id . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xem</button></a>
