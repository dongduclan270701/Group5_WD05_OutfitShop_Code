...
<body>
	...
	<main class="cd-main-content">
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" data-type="all">Trang chủ / Quần shorts</a></li>
		...
		<section class="cd-gallery">
			<ul>
			<?php
				foreach ($spants as $spantss){
					echo'<li class="mix '.$spantss->ProductName.' Màu-'.$spantss->Color.' spants"><img
					src="'.$spantss->Image1.'" alt="T-Shirt">
				<h5 class="jet-woo-product-title">
					<a href="index.php?controller=pages&action=PFull&ProductCode='.$spantss->ProductCode.'" rel="bookmark">
						'.$spantss->ProductName.'
					</a>
				</h5>
				<div class="jet-woo-product-price">
					<span class="woocommerce-Price-amount amount">
						<bdi> 
							'. number_format("$spantss->ProductPrice",0,",",","). ' 
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".Quần-dài" type="checkbox" id="checkbox3" checked>
							<label class="checkbox-label" for="Quần-dài">Quần dài</label>
						</li>
						<li>
							<input class="filter" data-filter=".spants" type="checkbox" id="v">
							<label class="checkbox-label" for="spants">Quần Shorts</label>
						</li>
						<li>
