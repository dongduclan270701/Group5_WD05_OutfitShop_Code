...
<?php
  ...
  font-size: 13px;">
                      ...
                      <tbody>';
                      foreach ($infor_category as $infor_categoryy){
                        echo '
                        <tr style="text-align: center;
                        font-size: 13px;">
                        <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_categoryy->id.'</p></th>
                        <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_categoryy->NameCategory.'</p></th>
                        <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_categoryy->Category.'</p></th>
                        
                        <th style="vertical-align: inherit;"><a href="index.php?controller=users&action=updateCategory&id=' . $infor_categoryy->id . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Sửa</button></a>
                        <a href="index.php?controller=users&action=showinforCategory&id=' . $infor_categoryy->id . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xem</button></a></th>
                      </tr>
                        ';
                      }
                      echo'</tbody></table>
