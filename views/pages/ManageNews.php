  ...
  <div class="col-sm-2 ">
      ...
      <div class="col-sm-10 ">
          ...
          <div class="navbar navbar-light list-voucher ">
                  <div class="row row3 ">
                      <div class="col ">
                        <a href="index.php?controller=users&action=insertNews">
                          <input type="submit" class="btn btn btn-sm btn-outline-secondary btnn  " value="Thêm tin tức"></a>
                      </div>
                  </div>
              </div>
...
font-size: 13px;">
                          <th>STT</th>
                          <th>Tiêu đề</th>
                          <th class="display">Người đăng</th>
                          <th class="display">Ngày đăng</th>
                          <th class="display">Thể loại</th>
                  ...
                  <tbody>';
                  foreach ($infor_news as $infor_newss){
                    echo '
                    <tr style="text-align: center;
                    font-size: 13px;">
                    <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_newss->id.'</p></th>
                    <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_newss->Title.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_newss->PostedBy.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_newss->DateSubmitted.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_newss->Category.'</p></th>
                    
                    <th style="vertical-align: inherit;"><a href="index.php?controller=users&action=updateNews&id=' . $infor_newss->id . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Sửa</button></a>
                    <a href="index.php?controller=users&action=showinforNews&id=' . $infor_newss->id . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xem</button></a></th>
                  </tr>
                    ';
                  }
                  echo'</tbody></table>
