...
<body>
	...
	<main class="cd-main-content">
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" data-type="all">Trang chủ / Áo khoác</a></li>
		...
		<section class="cd-gallery">
			<ul>
			<?php
				foreach ($jacket as $jackett){
					echo'<li class="mix '.$jackett->ProductName.' Màu-'.$jackett->Color.' jacket"><img
					src="'.$jackett->Image1.'" alt="T-Shirt">
				<h5 class="jet-woo-product-title">
					<a href="index.php?controller=pages&action=PFull&ProductCode='.$jackett->ProductCode.'" rel="bookmark">
						'.$jackett->ProductName.'
					</a>
				</h5>
				<div class="jet-woo-product-price">
					<span class="woocommerce-Price-amount amount">
						<bdi> 
							'. number_format("$jackett->ProductPrice",0,",",","). ' 
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".T-Shirt" type="checkbox" id="T-Shirt">
						...
						<li>
							<input class="filter" data-filter=".jacket" type="checkbox" id="jacket" checked>
							<label class="checkbox-label" for="jacket">Áo Khoác</label>
						</li>
						<li>
