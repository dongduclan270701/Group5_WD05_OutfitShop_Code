...
<?php include'header1.php' ?>
  <div class="container" style="max-width:1140px; margin-top:40px">
    <div class="row">
...
<div class="swiper-slide-bg">
  <div class="swiper-slide-contents1"><img
      src="'.$productbestw->Image1.'" alt="" style="width:100%;heigh: 303px;"></div>
...
<div class="swiper-slide-bg">
  <div class="swiper-slide-contents1"><img 
  src="'.$productbestw->Image2.'" alt="" style="width:100%;heigh: 303px;"></div>
