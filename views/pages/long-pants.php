...
<body>
	...
	<main class="cd-main-content">
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" data-type="all">Trang chủ / Quần dài</a></li>
		...
		<section class="cd-gallery">
			<ul>
			<?php
				foreach ($lpants as $lpantss){
					echo'<li class="mix '.$lpantss->ProductName.' Màu-'.$lpantss->Color.' lpants"><img
					src="'.$lpantss->Image1.'" alt="T-Shirt">
				<h5 class="jet-woo-product-title">
					<a href="index.php?controller=pages&action=PFull&ProductCode='.$lpantss->ProductCode.'" rel="bookmark">
						'.$lpantss->ProductName.'
					</a>
				</h5>
				<div class="jet-woo-product-price">
					<span class="woocommerce-Price-amount amount">
						<bdi> 
							'. number_format("$lpantss->ProductPrice",0,",",","). ' 
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".lpants" type="checkbox" id="lpants" checked>
							<label class="checkbox-label" for="lpants">Quần dài</label>
						</li>
						<li>
