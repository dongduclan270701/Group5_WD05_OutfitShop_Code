  ...
  <div class="col-sm-2 ">
          <div class="nav-head-content" style="    height: auto;">
              <ul id="accordion" class="accordion">
                ...
                <li>
                  <a href="index.php?controller=pages&action=inforOrder" style="text-decoration: none;"><div class="link color-text"><i class="fa fa-receipt"></i>Quản lý đơn hàng</div></a>
                </li>
...
font-size: 13px;">
                  ...
                  <tbody>';
                  foreach ($infor_order as $infor_orderr){
                                echo '
                                <tr style="text-align: center;
                                font-size: 13px;">
                                <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_orderr->orderId.'</p></th>
                                <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_orderr->UserName.'</p></th>
                                <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_orderr->Date.'</p></th>
                                <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.number_format($infor_orderr->SumPrice).'</p></th>
                                <th class="display" style="vertical-align: inherit;"><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_orderr->Status.'</p></th>
                            
                                <th style="vertical-align: inherit;"><a href="index.php?controller=users&action=updateOrder&orderId=' . $infor_orderr->orderId . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xử lý</button></a>
                              <a href="index.php?controller=users&action=showOrder&orderId=' . $infor_orderr->orderId . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xem</button></a></th>
                              </tr>
                                ';
                              }
                              echo'</tbody></table>
