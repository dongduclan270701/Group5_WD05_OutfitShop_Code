...
<?php include 'Header.php' ?>
    ...
    font-size: 13px;">
                        ...
                        <tbody>
                              <?php
                              foreach ($infor_day as $infor_dayy){
                                echo '
                                <tr style="text-align: center;
                                font-size: 13px;">
                                <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_dayy->Day.'</p></th>
                                <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_dayy->NumberOfProductsSold.'</p></th>
                                <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_dayy->RevenueDay.'</p></th>
                                <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_dayy->MaxRevenueProduct.'</p></th>
                                <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_dayy->MaxProduct.'</p></th>
                                <th style="vertical-align: inherit;"><a href="index.php?controller=pages&action=inforReport&Day=' . $infor_dayy->Day . '&Month=' . $infor_dayy->Month . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Sửa</button></a>
                              </th>
                              </tr>
                                ';
                              }
