  ...
  <div class="col-sm-2 ">
      ...
      <div class="col-sm-10 ">
          <div class="title1 ">
              <nav class="navbar navbar-light bg-light list-voucher">
                  <div class="container-fluid ">
                      <a class="navbar-brand ">Quản lý chương trình khuyến mãi</a>
                  </div>
              </nav>
          </div>
          ...
          <div class="navbar navbar-light list-voucher ">
                  <div class="row row3 ">
                      <div class="col ">
                        <a href="index.php?controller=users&action=insertSale">
                          <input type="submit" class="btn btn btn-sm btn-outline-secondary btnn  " value="Thêm mã giảm giá"></a>
                      </div>
                  </div>
              </div>
...
font-size: 13px;">
                          ...
                          <th class="display">Từ ngày</th>
                          <th class="display">Đến ngày</th>
                          <th class="display">Giá trị</th>
                          <th class="display">Trạng thái</th>
                          <th>Tác vụ</th>
                        </tr>
                      </thead>
                  
                  <tbody>';
                  foreach ($infor_sale as $infor_salee){
                    echo '
                    <tr style="text-align: center;
                    font-size: 13px;">
                    <th><p style=" font-weight: normal !important ;margin: auto; padding: inherit;">'.$infor_salee->DiscountCode.'</p></th>
                    <th><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_salee->DiscountName.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_salee->Since.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.$infor_salee->ToDate.'</p></th>
                    <th class="display"><p style=" font-weight: normal !important;margin: auto; padding: inherit;">'.number_format($infor_salee->Value).'₫</p></th>
                    <th class="display" style="vertical-align: inherit;">
                    '.$infor_salee->Status.'
                    </th>
                    <th style="vertical-align: inherit;"><a href="index.php?controller=users&action=updateSale&DiscountCode=' . $infor_salee->DiscountCode . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Sửa</button></a>
                    <a href="index.php?controller=users&action=showinforSale&DiscountCode=' . $infor_salee->DiscountCode . '"><button type="button " class="btn btn-sm btn-secondary btn-sua ">Xem</button></a></th>
                  </tr>
                    ';
                  }
                  echo'</tbody></table>
