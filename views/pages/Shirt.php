...
<body>
	...
	<main class="cd-main-content">
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" data-type="all">Trang chủ / Áo sơ mi</a></li>
		...
		<section class="cd-gallery">
			<ul>
			<?php
				foreach ($shirt as $shirtt){
					echo'<li class="mix '.$shirtt->ProductName.' Màu-'.$shirtt->Color.' Shirt"><img
					src="'.$shirtt->Image1.'" alt="">
				<h5 class="jet-woo-product-title">
					<a href="index.php?controller=pages&action=PFull&ProductCode='.$shirtt->ProductCode.'" rel="bookmark">
						'.$shirtt->ProductName.'
					</a>
				</h5>
				<div class="jet-woo-product-price">
					<span class="woocommerce-Price-amount amount">
						<bdi> 
							'. number_format("$shirtt->ProductPrice",0,",",","). ' 
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".Shirt" type="checkbox" id="Shirt"checked>
							<label class="checkbox-label" for="Shirt">Áo sơ mi</label>
						</li>
						<li>
